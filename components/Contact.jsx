        ...
        <div class="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
          <div class="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
            <iframe
              ...
              marginwidth="0"
              scrolling="no"
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3618.1268086962045!2d67.10630957610375!3d24.927749642560432!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3eb338c700571b09%3A0xd86779b29e77f36a!2sUIT%20University!5e0!3m2!1sen!2sus!4v1683791377741!5m2!1sen!2sus"
              allowfullscreen=""
              loading="lazy"
            ...
            <div class="bg-white relative flex flex-wrap py-6 rounded shadow-md">
              <div class="lg:w-1/2 px-6">
                ...
                <p class="mt-1">
                  ST-13 Abul Hasan Isphahani Rd, Block 7 Gulshan-e-Iqbal,
                  Karachi,
                </p>
              </div>
              <div class="lg:w-1/2 px-6 mt-4 lg:mt-0">
                ...
                <a class="text-indigo-500 leading-relaxed">
                  mobaidkhan2@gmail.com
                </a>
                <h2 class="title-font font-semibold text-gray-900 tracking-widest text-xs mt-4">
                  PHONE
                </h2>
                <p class="leading-relaxed">+92-3151272630</p>
              </div>
            </div>
          </div>
          <div class="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full  md:px-8  md:py-8 mt-8 md:mt-0">
            ...
            <p class="leading-relaxed mb-5 text-gray-600">
              Hey there! Do you have any feedback for us? Let us know and help
              us serve you better! 😊
            </p>
