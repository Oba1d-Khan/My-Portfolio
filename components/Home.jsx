      ...
      <div className="container mx-auto my-24 flex px-5  items-center justify-center flex-col">
        ...
        <div className="text-center lg:w-2/3 w-full">
          ...
          <div className="flex justify-center">
            <button className="inline-flex text-white bg-yellow-500 border-0 py-2 px-6 focus:outline-none rounded text-lg hover:text-gray-800 hover:transition-all duration-3500   ">
              PortFolio
              <svg
